...
# <span class="cod-php-modifier">final</span> class `ClassElement`

<a  href="https://github.com/beastbytes/cod-php/blob/master/src/Element/ClassElement.php">Source Code</a>
...
BeastBytes\CodPhp\Element\ClassElement<br>[BeastBytes\CodPhp\Element\ObjectElement](object-element.md)<br>[BeastBytes\CodPhp\Element\Element](element.md)

</td></tr><tr><th>Uses</th><td>

[BeastBytes\CodPhp\Element\ModifierTrait](modifier-trait.md)<br>[BeastBytes\CodPhp\Element\PropertyTrait](property-trait.md)
...
Declared in BeastBytes\CodPhp\Element\ClassElement
