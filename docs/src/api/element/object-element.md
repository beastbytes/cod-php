...
BeastBytes\CodPhp\Element\ObjectElement<br>[BeastBytes\CodPhp\Element\Element](element.md)

</td></tr><tr><th>Subclasses</th><td>

[BeastBytes\CodPhp\Element\ClassElement](class-element.md)<br>[BeastBytes\CodPhp\Element\EnumElement](enum-element.md)<br>[BeastBytes\CodPhp\Element\InterfaceElement](interface-element.md)<br>[BeastBytes\CodPhp\Element\TraitElement](trait-element.md)
...
<table><tbody><tr><td colspan="3"><span class="cod-php-visibility">public</span>  function pathTo(<span class="cod-php-type">BeastBytes\CodPhp\Element\ObjectElement|<a  href="https://www.php.net/manual/en/language.types.string.php">string</a></span> $destination): <span class="type"><a  href="https://www.php.net/manual/en/language.types.string.php">string</a>|<a  href="https://www.php.net/manual/en/language.types.null.php">null</a></span></td></tr><tr><td>$destination</td><td>BeastBytes\CodPhp\Element\ObjectElement|<a  href="https://www.php.net/manual/en/language.types.string.php">string</a></td><td>The FQCN or element to get the path to.</td></tr><tr><td>return</td><td><a  href="https://www.php.net/manual/en/language.types.string.php">string</a>|<a  href="https://www.php.net/manual/en/language.types.null.php">null</a></td><td>Relative path to the element from this element or `null` if $element is this element.</td></tr></tbody></table>
