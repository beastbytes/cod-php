...
BeastBytes\CodPhp\Element\ClassConstantElement<br>[BeastBytes\CodPhp\Element\Element](element.md)

</td></tr><tr><th>Uses</th><td>

[BeastBytes\CodPhp\Element\DeclaringClassTrait](declaring-class-trait.md)<br>[BeastBytes\CodPhp\Element\ValueToStringTrait](value-to-string-trait.md)
...
Declared in BeastBytes\CodPhp\Element\ClassConstantElement
