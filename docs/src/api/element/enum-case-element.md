...
BeastBytes\CodPhp\Element\EnumCaseElement<br>[BeastBytes\CodPhp\Element\Element](element.md)
...
Declared in BeastBytes\CodPhp\Element\EnumCaseElement
...
### $value
Case value for EnumBackedCase; `null` if not a backed Enum case.

| Type | Read/Write | Default |
|-|:-:|-|
| <a  href="https://www.php.net/manual/en/language.types.string.php">string</a>\|<a  href="https://www.php.net/manual/en/language.types.integer.php">int</a>\|<a  href="https://www.php.net/manual/en/language.types.null.php">null</a>\|<a  href="https://www.php.net/manual/en/language.types.null.php">null</a> | Read |  |
