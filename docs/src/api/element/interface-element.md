...
BeastBytes\CodPhp\Element\InterfaceElement<br>[BeastBytes\CodPhp\Element\ObjectElement](object-element.md)<br>[BeastBytes\CodPhp\Element\Element](element.md)

</td></tr><tr><th>Uses</th><td>

[BeastBytes\CodPhp\Element\PropertyTrait](property-trait.md)
